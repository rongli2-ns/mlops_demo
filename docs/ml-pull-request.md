...
Links:
* [Staging model in UC](https://nscorp-dev.cloud.databricks.com/explore/data/models/staging/mlops_demo/mlops_demo-model)
* [Prod model in UC](https://nscorp-dev.cloud.databricks.com/explore/data/models/prod/mlops_demo/mlops_demo-model)
. 
